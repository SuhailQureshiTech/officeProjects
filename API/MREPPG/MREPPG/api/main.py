...
credentials = service_account.Credentials.from_service_account_file(
    'D:/ars\data-light-house-prod-0baa98f57152.json')
...
async def all_sales(fromDate: date, toDate: date, distCode: Optional[str] = None, dataFlag: Optional[str] = None, limit=100):
...
if __name__ == "__main__":
    ...
    # http://localhost:9001/sales?fromDate=2022-07-01&toDate=2022-07-03
    # http://localhost:9001/sales/dist?fromDate=2022-07-01&toDate=2022-07-03&distCode=8026
    # http://localhost:9001/sales/dist?fromDate=2022-07-01&toDate=2022-07-03&dataFlag=OPS
    # http://localhost:9001/sales/dist?fromDate=2022-07-01&toDate=2022-07-03&dataFlag=OPS
