...
def update_shopify_products_sap():
    ...
    url = f"https://{api_key}:{token}@restoreonline.myshopify.com/admin/api/2022-01/products.json"
    payload = ""
    headers = {
    ...
    url2 = f"https://{api_key}:{token}@restoreonline.myshopify.com/admin/api/2022-01/products.json"
    ...
    for i in range(0,len(df_parsed)):
        url_update = f"https://{api_key}:{token}@restoreonline.myshopify.com/admin/api/2022-01/products/{df_parsed[i]['id']}.json"
...
Shopify_Products_API = DAG(
    dag_id='Shopify_Products_API',
    default_args=default_args,
    # schedule_interval='0 0 * * *',
    schedule_interval='*/30 * * * *',
    catchup=False,    
   # dagrun_timeout=timedelta(minutes=60),
    description='Shopify_Products_Update_From_SAP',
)

t0 =   PythonOperator(
        task_id="Shopify_get_update_products_from_sap",
        python_callable=update_shopify_products_sap,
        dag=Shopify_Products_API
)
