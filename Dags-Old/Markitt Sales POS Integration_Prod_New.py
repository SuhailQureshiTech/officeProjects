...
def get_markitt_POS_header_data():
    ...
    delRecQuery = f'''
                delete from ZMARKIT_ITEM where cast(billdate as date) between  {maxDate} and {dateDate}
    '''
    ...
    insertZmarkittItems=f''' INSERT INTO SAPABAP1.ZMARKIT_ITEM  (MANDT,BILLNO,SERIALNO,BRANCH,BILLDATE,MATERIAL,QUANTITY,RATE,AMOUNT,ITEMDISCOUNTAMOUNT,NETAMOUNT,ITEMGSTAMOUNT,ZMODE,FLAG)
            ...
            FROM ZMARKIT_ITEM zi WHERE  1=1   AND cast(BILLDATE as date) between  {maxDate} and {dateDate}
    '''
    ...
    insertZmarkitt = f''' INSERT INTO SAPABAP1.ZMARKIT(MANDT,BILLNO,SERIALNO,BRANCH,BILLDATE,MATERIAL,QUANTITY,RATE,AMOUNT,ITEMDISCOUNTAMOUNT,NETAMOUNT,ITEMGSTAMOUNT,ZMODE,FLAG)
                ...
                WHERE 1=1 AND cast(billdate as date) between  {maxDate} and {dateDate}
                ) as rows
                    where row_number = 1
                '''
...
def send_email(context):
    ...
    send_email_smtp(to=['muhammad.suhail@iblgrp.com']
                ,cc=['muhammad.suhail@iblgrp.com', 'Fahad.Kasiri@habitt.com', 'Umer.Altaf@iblgrp.com','Arshad.Ali@habitt.com'
                        ,'Muhammad.Fayyaz@Markitt.com', 'Asad.Iqbal@Markitt.com','Ali.Babur@habitt.com'
                        ,'Noman.Ali@habitt.com','Muhammad.Shoaib@Markitt.com','orasyscojava@gmail.com']
                    ,subject=subject
                    , html_content=msg
                    )
...
Markitt_Sales_POS_Prod = DAG(
    dag_id='Markitt_Sales_POS_Prod_New',
...
def email():
    ...
    if len(data_concat) > 0:
        ...
        send_email_smtp(to=['Asad.Iqbal@Markitt.com', 'Noman.Ali@habitt.com'
                ...
                ,'Muhammad.Fayyaz@Markitt.com', 'Ali.Babur@habitt.com', 'orasyscojava@gmail.com' ]
...
executDataValidation >> Generate_Markitt_Data
