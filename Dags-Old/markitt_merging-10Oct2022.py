...
grnBq = gcs_to_bq.GoogleCloudStorageToBigQueryOperator(
    ...
    schema_fields=[
        ...
        {'name': 'reporting_date', 'type': 'DATE', 'mode': 'NULLABLE'}, {'name': 'material', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 'plt', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 'sloc', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 'mvt', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 's', 'type': 'STRING', 'mode': 'NULLABLE'}, {
            'name': 'mat_doc', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 'item', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 'posting_date', 'type': 'DATE', 'mode': 'NULLABLE'}, {'name': 'quantity_in_une', 'type': 'INTEGER', 'mode': 'NULLABLE'}, {'name': 'eun', 'type': 'STRING', 'mode': 'NULLABLE'}, {'name': 'transfer_date', 'type': 'TIMESTAMP', 'mode': 'NULLABLE'}
    ],
...
deleteGrnBQRecords >> deletePoBQRecords >> deletePurchaseBQRecords>>[
    grnDataGenerationTask, poDataGenerationTask , purchaseDataGenerationTask]>>grnBq >> poBq>>purchaseBq
