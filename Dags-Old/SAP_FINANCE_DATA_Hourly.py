...
def insertSapBkpfData():
	...
	, "CTXKRS"
    FROM SAPABAP1.bkpf
    WHERE 1=1 and mandt=300 and budat between {vEndDate} and {vMaxDate}
    ...
    delete_sql = f'''DELETE FROM hanadb_prd.bkpf_new where budat between {vPostEndDate} and {vPostMaxDate}
                                and bukrs in ('1000',
												'1100',
												'1200',
												'1500',
...
def insertSapBsegData():
    ...
    WHERE 	budat  between  {vEndDate}  and {vMaxDate}
    '''
    ...
    delete_sql = f'''DELETE FROM hanadb_prd.bseg_new where budat between{vPostEndDate} and {vPostMaxDate}
                            and bukrs in (
												'1000',
												'1100',
												'1200',
