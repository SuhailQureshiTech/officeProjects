...
def insertSapSales():
    ...
    select
        ...
        --	concat("VBRK"."KNUMV", '-', "VBRP"."POSNR") UP_KEY,
            ...
            "VBRK"."KNUMV" knumv,
            "VBRP"."POSNR" posnr,
            CASE WHEN "VBAK"."AUGRU" IS NULL THEN VBAP.ABGRU ELSE "VBAK"."AUGRU" END AUGRU AUGRU
...
def insertData():
    ...
    # sql_command = f'''
    #     SELECT
    #     ITEM_CATEGORY item_category	,ORG_ID branch_id,ORG_DESC "branch_description",TRX_DATE "billing_date"
    #     ,TRX_NUMBER "document_no",BOOKER_ID "booker_id",BOOKER_NAME "booker_name",SUPPLIER_ID "supplier_id"
    #     ,SUPPLIER_NAME "supplier_name",BUSINESS_LINE_ID "business_line_id",BUSINESS_LINE "business_line_description"
    #     ,CHANNEL "channel",CUSTOMER_ID "customer_id",CUSTOMER_NUMBER "customer_number",CUSTOMER_NAME "customer_name"
    #     ,SALES_ORDER_TYPE "sales_order_type",INVENTORY_ITEM_ID "inventory_item_id",ITEM_CODE "item_code"
    #     ,DESCRIPTION "item_description",UNIT_SELLING_PRICE "unit_selling_price",SOLD_QTY "sold_qty"
    #     ,BONUS_QTY "bonus_qty",CLAIMABLE_DISCOUNT "claimable_discount"
    #     ,UNCLAIMABLE_DISCOUNT "unclaimable_discount",TAX_RECOVERABLE "tax_recoverable",NET_AMOUNT "net_amount"
    #     ,GROSS_AMOUNT "gross_amount",TOTAL_DISCOUNT "total_discount",CUSTOMER_TRX_ID "customer_trx_id"
    #     ,REASON_CODE "reason_code"
    #     ,BILL_TYPE_DESC "bill_type_description",COMPANY_CODE "company_code",BILLING_TYPE "billing_type"
    #     ,SALES_ORDER_NO "sales_order_no"
    #     ,ADD1 "address_1",ADD2 "address_2",ADD3 "address_3",BSTNK "salesflo_order_no"
    #     ,ITEM_NO "item_no",RETURN_REASON_CODE "return_reason_code"
    #     FROM
    #         PHNX_SALES_DATA
    #     WHERE  trx_date={vEndDate}
    # '''
    ...
    # connect_string = 'postgresql+psycopg2://scriptuser:userIbl123_456@192.168.130.81:5433/hanadb_prd'
    # engine1 = sqlalchemy.create_engine(connect_string)

    # del_sql_statement = f'''delete from "DW"."IBL_SALES"
    #                 where billing_date={vEndDate}
    #             '''
