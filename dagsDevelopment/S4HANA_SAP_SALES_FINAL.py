...
print('today creationDate : ',creationDate)
...
def checkConnection():
    sql='select * from etl.zpbi_plants'
    df=pd.read_sql(sql,con=sapEngine)
    print(df)
...
def insertSapSales():
    ...
    select
        ...
        where 1 = 1   and "FKDAT"  between '20230701' and '20230731'
                and "VBRK"."VKORG" in ('6300', '6100') 
                and "VBRK"."FKART" in ( 'ZOPC', 'ZOCC', 'ZUBC', 'ZUCC', 'ZORE', 'ZORC', 'ZURB', 'ZUB1', 'ZNES', 'ZNEC')
                '''
