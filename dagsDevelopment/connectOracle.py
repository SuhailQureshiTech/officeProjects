...
try:    
    print('connecting....')
    engine = create_engine('oracle+cx_oracle://loreal1:Loreal1106@Sap-Router-e416ea262b67e5f4.elb.ap-southeast-1.amazonaws.com:6464/?service_name=cdb1')
    print(engine)
...
#         ORG_ID ,    ORG_DESC ,  CHANNEL_DESC,DATA_FLAG,unit_selling_price
    ...
    sqlQuery = f'''
                            ...
                            BARCODE,
                            TO_DATE(SUBSTR(dATE_,1,4)||'-'||SUBSTR(dATE_,5,2)||SUBSTR(dATE_,7,2),'YYYY-MM-DD')dATE_,
                        ...
                        WHERE 1=1 
                        AND to_number(Date_) between '20230902' and '20230918'
    ...
    dataFrame1=pd.read_sql(sqlQuery,con=engine)
    print(dataFrame1)
