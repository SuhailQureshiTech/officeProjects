...
WHERE 1 =1 and delivery_date>='2022-01-03' --and sales_order_no=3900188747
group by 
COMPANY_CODE
	,ORG_ID
	,ORG_DESC
...
FROM 
  (
    ...
    select 
      ...
      PSDD.CLAIMABLE_DISCOUNT CLAIMABLE_DISCOUNT, 
      PSDD.UNCLAIMABLE_DISCOUNT UNCLAIMABLE_DISCOUNT, 
      CASE WHEN (PSDD.SALES_ORDER_TYPE LIKE '%CANCEL%' OR PSDD.SALES_ORDER_TYPE LIKE '%RETUR%') AND PSDD.TAX_RECOVERABLE >0 
      	THEN PSDD .TAX_RECOVERABLE *-1 ELSE  	PSDD.TAX_RECOVERABLE END TAX_RECOVERABLE, 
      PSDD.GROSS_AMOUNT NET_AMOUNT, 
      PSDD.UNCLAIMABLE_DISCOUNT + PSDD.CLAIMABLE_DISCOUNT TOTAL_DISCOUNT, 
